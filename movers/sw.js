...
self.addEventListener('message',event=>{
  ...
  if(data.type==='IS_AUDIO_CACHED'){
    event.waitUntil((async()=>{
      ...
      port?.postMessage({ok:true,cached:!!match});
    })());
  }
});
